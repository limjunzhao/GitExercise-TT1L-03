...
class Morsecode:
    ...
    def run(self):
        ...
        while running:
            ...
            question_background_rect = pygame.Rect(NOTES_WIDTH + 20, 20, question_text_width + 40, 2 * FONT_SIZE_GAME + 5 + 30 + 40)
            pygame.draw.rect(self.display_surface, (200, 200, 200, 150), question_background_rect)  # Semi-transparent gray background

            # Draw background rectangle behind the input
            input_background_rect = pygame.Rect(NOTES_WIDTH + 20, 260, question_text_width + 40, FONT_SIZE_GAME + 5 + 40 + 30)
            pygame.draw.rect(self.display_surface, (200, 200, 200, 150), input_background_rect)  # Semi-transparent gray background
