...
# Function to draw an outlined rounded rectangle
def draw_outlined_rounded_rect(surface, rect, color, outline_color, corner_radius, outline_width):
    # Draw the filled rounded rectangle
    draw_rounded_rect(surface, color, rect, corner_radius)
    # Draw the outline by drawing a larger rounded rectangle with transparency
    draw_rounded_rect(surface, outline_color, rect.inflate(outline_width, outline_width), corner_radius + outline_width//2)
