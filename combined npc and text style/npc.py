...
class Dialogue:
    ...
    #blit all text 
    def blit_text(self, surface, text, color, rect, font):
        
        line = []
        text = font.render(text, True, color)
        y = rect.top + 10
        text_rect = text.get_rect(topleft=(rect.left + 5, y))
    ...
    def render_typewriter_npc_speech(self, surface, text, color, rect, font):
        ...
        for i in range(len(text) + 1):
            ...
            self.blit_text(surface, text, color, rect, font)    
            pygame.display.flip()
            clock.tick(20)
...
player = Player()
npc_ques = [ 
    {'where' : 'where you at last night'}, 
    {'who' : 'who are you, whats your name?'},
